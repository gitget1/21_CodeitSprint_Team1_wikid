function Footer() {
  return (
    <div className="flex min-w-0 max-w-full flex-col items-start justify-center bg-gray-600 px-5 py-10 md:px-12 md:py-15 xl:h-[270px] xl:p-20">
      <span className="text-gray-50 text-[10px] leading-[18px] font-bold md:text-[16px] md:leading-[26px]">
        Copyright ⓒ Wikied. All Rights Reserved
      </span>
      <span className="mt-[10px] max-w-full break-words text-gray-50 text-[8px] leading-[14px] font-normal md:text-[14px] md:leading-[24px]">
      ...
      <div className="mt-5 flex min-w-0 max-w-full flex-wrap items-center justify-start gap-4 md:mt-[30px] md:gap-[30px]">
        <a href="" className="text-gray-50 text-[8px] leading-[14px] font-medium md:text-[14px] md:leading-[24px]">
          서비스 이용약관
        </a>
        <a href="" className="text-gray-50 text-[8px] leading-[14px] font-medium md:text-[14px] md:leading-[24px]">
          개인정보 취급방침
