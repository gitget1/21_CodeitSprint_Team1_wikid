  ...
  return (
    <div className="flex min-w-0 w-[860px] max-w-full flex-col justify-center gap-3 min-[745px]:h-[112px]">
      ...
      <div className="flex min-w-0 flex-wrap items-center gap-[10px]">
        ...
        >
          <span className="inline-flex h-5 w-5 shrink-0 items-center justify-center text-primary-green-300 transition-colors group-hover:text-white -translate-y-0.5">
            <LinkIcon className="block h-5 w-5 shrink-0 text-current" aria-hidden />
          </span>
